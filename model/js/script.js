...
function shareVia(method) {
    playSound('click');
    const shareUrl = 'https://dillistudio.github.io/dilliraja/';
...
Sent from your portfolio website.`;
    ...
    window.open(`https://wa.me/9500388259?text=${encodeURIComponent(waMessage)}`, '_blank');
